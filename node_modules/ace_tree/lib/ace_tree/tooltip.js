...
"use strict";
var dom = require("ace_tree/lib/dom");
var lang = require("ace_tree/lib/lang");
...
(function() {
    this.setUp = function() {
        ...
        this.root.className = container.className;
    ...
    this.updateNode = function(treeNode) {
        ...
        this.root.className = this.tree.container.className;
