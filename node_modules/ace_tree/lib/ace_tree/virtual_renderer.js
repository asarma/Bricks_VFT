...
var pivotCss = require("./requirejs/text!./css/tree.css");
...
(function() {
    ...
    this.setDataProvider = function(provider) {
        ...
        if (this.scrollMargin.top && provider.getScrollTop() <= 0)
        ...
        this.$size.headingHeight = provider.columns
    ...
    **/
    ...
    this.$updateCachedSize = function(force, width, height) {
        ...
        if (height && (force || size.height != height)) {
            ...
            if (this.provider && this.provider.setScrollTop) {
                // this.provider.setScrollTop(this.getScrollTop());
        ...
        if (width && (force || size.width != width)) {
            ...
            if (this.provider && this.provider.columns)
    ...
    this.$renderChanges = function(changes, force) {
        ...
        if ((!this.provider || !this.container.offsetWidth) || (!changes && !force)) {
    ...
    this.$autosize = function() {
        ...
        var maxHeight = this.$maxLines * this.provider.rowHeight + headingHeight;
