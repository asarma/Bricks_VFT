...
(function(){
    ...
    this.setDataProvider = function(provider) {
        if (this.provider) {
            ...
            oldProvider.off("changeClass", this.$caretChange);
        ...
        this.provider.on("changeClass", this.$onCaretChange);
     ...
     **/
    this.navigateLevelUp = function() {
        var node = this.selection.getCursor();
        if (!node) {
            // continue
        } else if (this.provider.isOpen(node)) {
