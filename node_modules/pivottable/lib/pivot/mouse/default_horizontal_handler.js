...
function HorizontalHandler(mouseHandler) {
    ...
    var htmlNode = editor.renderer.$horheading;
    ...
    function setDragInfo(e){
        ...
        var rect   = editor.renderer.$horheading.getBoundingClientRect();
    ...
    mouseHandler.editor.setDefaultHandler("horizontalmousedown", function(e) {
        if (!setDragInfo(e)) {
            layer.toggle(getHeadingCell(e), function(succes){
                if (succes) {
        ...
        mouseHandler.setState("resizeHorizontal");
    ...
    mouseHandler.editor.setDefaultHandler("horizontalclick", function(e) {
        // Detect menu click
    ...
    mouseHandler.editor.setDefaultHandler("horizontalmousemove", function(e) {
        if (!dragging) {
        ...
        mouseHandler.resizeHorizontal(e);
    });
    
    mouseHandler.resizeHorizontal = function(e){
    ...
    event.addListener(htmlNode, "mouseup", function(e) {
        ...
        mouseHandler.resizeHorizontalEnd();
    });
    
    mouseHandler.resizeHorizontalEnd = function(){
        dragging = false;
