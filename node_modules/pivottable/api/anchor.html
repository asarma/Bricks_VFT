        ...
        <div class="memberContent">
          ...
          <div class="sideToggler">
            ...
            <div class="description"><p>Creates a new <code>Anchor</code> and associates it with a document.</p>
              ...
              <h4>Arguments</h4><table class="argumentTable argument-list table table-striped table-bordered"><tr class="argumentRow "><td class="argName ">doc</td><td class="argType" ">undefined</td><td class="argDescription "><p>Required. The document to associate with the anchor</p>
