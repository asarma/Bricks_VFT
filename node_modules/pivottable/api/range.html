...
<div id="documentation" class="span9">
  <div class="classContent">
    ...
    <div class=" members pos0">
      <div class=" membersContent pos0">
        ...
        <ul data-tabs="tabs" class="nav tabs pos0">
          ...
          <li data-dropdown="dropdown" class="dropdown"><a href="#" data-toggle="dropdown" class="dropdown-toggle"><span>Functions (28)</span><b class="caret"></b></a>
            <ul class="dropdown-menu">
              ...
              <li id="dropdown_Range.comparePoints" data-id="Range.comparePoints" class="memberLink"><a href="#Range.comparePoints" class="" title="Range.comparePoints (class method)" data-id="Range.comparePoints">comparePoints</a>
              </li>
              ...
              <li id="dropdown_Range.moveBy" data-id="Range.moveBy" class="memberLink"><a href="#Range.moveBy" class="" title="Range.moveBy (class method)" data-id="Range.moveBy">moveBy</a>
              </li>
    ...
    <article id="Range.comparePoints" data-title="Range.comparePoints (class method)" class="article">
      <div class="section method">
        <div class="memberContent">
          <div class="title"><i id="Range.comparePoints" class="methodToggle methodClicker inactive icon-caret-right"></i>
            <ul class="signatures">
              <li class="signature">
                <ul>
                  <li class="signature-call"><span id="Range.comparePoints" class="member-name methodClicker"><span class="sigClassName">Range.</span><span class="sigMemberName">comparePoints</span></span><span class="emptyArgumentList">()</span></li>
                </ul>
                <ul class="metaInfo">
          ...
          <div class="sideToggler">
            <div id="ellipsis_Range.comparePoints" class="ellipsis_description">
            </div>
...
<pre><code class="language-javascript">   <span class="keyword">this</span>.start.row &lt;= row &lt;= <span class="keyword">this</span>.end.row &amp;&amp;
   <span class="keyword">this</span>.start.column &lt;= column &lt;= <span class="keyword">this</span>.end.column</code></pre>
    ...
    <article id="Range.moveBy" data-title="Range.moveBy (class method)" class="article">
      <div class="section method">
        <div class="memberContent">
          <div class="title"><i id="Range.moveBy" class="methodToggle methodClicker inactive icon-caret-right"></i>
            <ul class="signatures">
              <li class="signature">
                <ul>
                  <li class="signature-call"><span id="Range.moveBy" class="member-name methodClicker"><span class="sigClassName">Range.</span><span class="sigMemberName">moveBy</span></span><span class="emptyArgumentList">()</span></li>
                </ul>
                <ul class="metaInfo">
                  <li><span class="label undocumented">Undocumented</span></li>
                </ul>
          ...
          <div class="sideToggler">
            <div id="ellipsis_Range.moveBy" class="ellipsis_description">
            </div>
            <div class="description">
            </div>
          </div>
        ...
        <div class="memberContent">
          <div class="title"><i id="Range.toScreenRange" class="methodToggle methodClicker inactive icon-caret-right"></i>
            <ul class="signatures">
              <li class="signature">
                <ul>
                  <li class="signature-call"><span id="Range.toScreenRange" class="member-name methodClicker"><span class="sigClassName">Range.</span><span class="sigMemberName">toScreenRange</span></span>(<span class="sigArgList"><a href="https://developer.mozilla.org/en-US/docs/JavaScript/Reference/Global_Objects/Object" class="argument methodClicker" title="Object" data-id="Object">Object</a> session</span>)
                    <li class="signature-returns">
                      <ul class="argument-types">
                        <li class="argument-type"><a href="range.html" class="returnType " title="Range (class)" data-id="Range">Range</a></li>
                      </ul>
