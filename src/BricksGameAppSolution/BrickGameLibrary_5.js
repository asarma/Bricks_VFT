...
//Task #1 - V3 (incorrect variant)
/**********************************************
* @Author:Smith                               *
* @Last-Update-Date: 12-10-2013               *
* @Description: changed the rgb values        *
* *********************************************/
...
//*********************************************
   ...
   ctx.beginPath();  
   polygon(ctx,paddlex+5,HEIGHT - paddleh+5,paddlew-15,8,Math.PI/2);
   ctx.closePath();
   ctx.fillStyle="rgba(227,141,43,0.75)";
   ctx.fill();
   ctx.stroke();
