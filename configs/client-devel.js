...
module.exports = function(options) {
    ...
    var sass = options.sassBin || "sass";
    var coffee = options.coffeeBin || "coffee";
    var lessc = options.lesscBin || "lessc";
    var tsc = options.tscBin || "tsc";
    var node = options.nodeBin || "node";
    ...
    return [
        ...
        {
            packagePath: "plugins/c9.vfs.client/endpoint.standalone",
            projectId: options.projectId,
            projectUrl: options.projectUrl,
            homeUrl: options.homeUrl,
            socketUrl: options.smithIo.path
        },
        {
        ...
        },
        {
            ...
            nak         : options.nakBin || (options.platform == "win32" 
                ? "nak.cmd" : "~/.c9/node_modules/nak/bin/nak")
        },
        // {
        ...
        // "plugins/logicblox.core/logicblox",
