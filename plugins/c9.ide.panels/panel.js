    ...
    function main(options, imports, register) {
        ...
        function Panel(developer, deps, options){
            ...
            plugin.on("load", function(){
                ...
                panels.on("showPanel" + plugin.name.uCaseFirst(), function(e){
                ...
                panels.on("hidePanel" + plugin.name.uCaseFirst(), function(e){
                    if (button)
                ...
                settings.on("read", function(){
                    ...
                    ["left", "right"].forEach(function(where){
                        ...
                        if ((!active && areas[where].defaultActive == plugin.name
                          || active == plugin.name))
                            areas[where].activate(plugin.name, true, true);
                    });
                });
            });
            ...
            function draw(){
                ...
                if (aml) {
                    ...
                    aml.setAttribute("anchors", where == "left"
                        ? "0 0 0 " + area.width
                        : "0 " + area.width + " 0 0");
                }
            ...
            function hide(){
                if (panels.isActive(plugin.name)) {
                    if (autohide && lastPanel && !panels.panels[lastPanel].autohide)
            ...
            /**
             * Panel base class for the Cloud9 IDE UI. Panels can
