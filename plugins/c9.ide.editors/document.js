define(function(require, module, exports) {
    ...
    function main(options, imports, register) {
        ...
        var counter = 0, sessionCounter = 0;
        ...
        function Document(options){
            ...
            function getSession(){
                var ed = editor || tab.editor;
                if (!ed) return;
                
                if (sessions[ed.type])
                    return sessions[ed.type];
                
                var session = sessions[ed.type] = new Plugin();
                session.load("session" + sessionCounter++);
                return session;
            }
            ...
            /**
             * Session Class for Cloud9 IDE Editors. Each document that is loaded into an
             ...
             */
            /**
             * Document Class for Cloud9 IDE Editors. Each file that is opened
