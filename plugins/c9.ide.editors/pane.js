define(function(require, module, exports) {
    ...
    function main(options, imports, register) {
        ...
        function Pane(options){
            var amlPane, queue, cancelEditorCreate;
            ...
            function load(){
                ...
                amlPane = new ui.tab({
                    ...
                    animate    : "[{settings.model}::user/general/@animateui]",
                    ...
                    onafterswitch  : function(e){
                        ...
                        createEditor(tab.editorType, function(err, editor){
                            editor.loadDocument(tab.document, tab.undoManager);
                ...
                if (next) {
                    ...
                    // Move to next pane
                        ...
                        tab.attachTo(next.cloud9pane, 
                            far ? (next.getTabs()[0] || 1).cloud9tab : null, true);
                        tab.activate();
            ...
            anims.on("animate", function(e){
                ...
                if (e.type == "editor") {
                    ...
                    if (e.options.height !== undefined) {
                        if (ui.isChildOf(e.other, amlPane, true)) {
                            ...
                            delta  = size - parseInt(e.options.height, 10);
                ...
                }, (e.duration * 1000) + 50); // Buffer for slow machines
            }, plugin);
            ...
            plugin.on("beforeUnload", function(){
                ...
                // I don't know why this is here, the panel is unloading.
                // resizeAll();
            });
            ...
            /**
             * Represents a pane containing tabs in Cloud9 IDE. Cloud9 IDE
            ...
            plugin.freezePublicAPI({
                 ...
                 * @param {Boolean}  far  When set to true the new pane is
                 *   created in the right of the split, otherwise it's created
                 *   as the left pane.
                 */
                hsplit : hsplit,
