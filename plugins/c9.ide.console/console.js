    ...
    function main(options, imports, register) {
        ...
        function load(){
            ...
            menus.addItemByPath("View/Console", new apf.item({
                ...
                checked : "[{settings.model}::state/console/@expanded]"
            }), 700, plugin);
            ...
            settings.on("read", function(e){
                ...
                // Height
                height = e.model.queryValue("state/console/@height");
        ...
        function draw(){
            ...
            splitter && splitter.on("dragdrop", function(e){
                settings.set("state/console/@height", height = container.height);
                emit("resize");
            });
        ...
        function restoreConsoleHeight(){
            ...
            settings.model.setQueryValue("state/console/@maximized", false);
