            ...
            function Dashboard(){
                ...
                function focusWidget(widget){
                    if (focussedWidget != widget) {
                        ...
                        if (focussedWidget) {
                            ...
                            focussedWidget.className.remove("focus");
                        }
                        ...
                        focussedWidget.className.add("focus");
                    }
                    else {
                        if (!focussedWidget)
                            return;
                ...
                plugin.on("documentActivate", function(e){
                    ...
                    container.$ext.querySelector(".heading_title").innerHTML 
                        = (currentSession.title || "").uCaseFirst() + " Dashboard";
                });
                ...
                handleEmit("create", {dashboard: plugin}, true);
                
                plugin.load("dashboard" + counter++);
