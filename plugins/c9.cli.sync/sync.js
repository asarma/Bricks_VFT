define(function(require, exports, module) {
    main.consumes = ["Plugin", "commands", "workspace", "settings", "fs", "proc"];
    main.provides = ["sync"];
    return main;
    ...
    function main(options, imports, register) {
        ...
        function checkVersion(ws, callback){
            ...
            proc.execFile("unison", {args: ["-version"]}, function(err, e){
                ...
                localVersion = e.stdout.match(/unison version ([\d\.]+)/) && parseInt(RegExp.$1);
                ...
                ws.proc.execFile("unison", {args: ["-version"]}, function(err, e){
                    ...
                    remoteVersion = e.stdout.match(/unison version ([\d\.]+)/) && parseInt(RegExp.$1);
