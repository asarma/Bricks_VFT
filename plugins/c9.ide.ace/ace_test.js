            ...
            describe("setOption()", function(){
                ...
                it('should change a theme', function(done) {
                    ...
                    editor.ace.renderer.on("themeLoaded", function me(e){
                        ...
                        ace.on("themeChange", function setTheme2(){
                            ace.off("theme.change", setTheme2);
                            done();
                        });
...
//                    render();
//                    
//                    expect(session.getLength()).to.equal(1);
//                    
//                    editor.setOption("newlineMode", "unix");
//                    
//                    expect(session.getLength()).to.equal(5);
//                    
//                    done();
//                });
                ...
                it('should allow setting fontFamily', function(done) {
                    ...
                    expect(editor.ace.container.style.fontFamily).to.equal("'Courier New'");
                    
                    var font = "Monaco, Menlo, 'Ubuntu Mono', Consolas, source-code-pro, monospace";
                    editor.setOption("fontFamily", font);
                    render();
                    
                    expect(editor.ace.container.style.fontFamily).to.equal(font);
                ...
                it('should allow setting selectionStyle', function(done) {
                    ...
                    var chars = document.querySelectorAll(".ace_selection")[0].offsetWidth / charWidth
                    expect(chars).to.equal(10);
                    
                    editor.setOption("selectionStyle", "line");
                    render();
                    
                    chars = document.querySelectorAll(".ace_selection")[0].offsetWidth / charWidth
