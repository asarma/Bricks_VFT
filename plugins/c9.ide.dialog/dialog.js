define(function(require, module, exports) {
    main.consumes = ["Plugin", "ui", "commands"];
        ...
        function Dialog(options){
            ...
            function queue(implementation, force){
                ...
                return Dialog.addToQueue(dialog, function(next){
                    ...
                    // Update UI
                    titles.$int.innerHTML = "<h3 style='margin:0 0 10px 0'>" + heading + "</h3>"
                        + "<div class='alertMsg'>" + body + "</div>";
            ...
            /**
             * Dialog Builder for Cloud9 IDE. Use this class to create dialogs.
             * 
             * Example:
             * 
            ...
            plugin.load(name || "dialog" + counter++);
