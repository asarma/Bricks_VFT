define(function(require, exports, module) {
    main.consumes = ["Plugin", "settings", "commands", "layout", "anims", "ui"];
    ...
    function main(options, imports, register) {
        ...
        function checkItems(e){
            if (e.value) {
                ...
                for (var a, fn, cmd, n, i = nodes.length - 1; i >= 0; i--) {
        ...
        function setSubMenu(parent, name, index, item, menu, plugin){
        ...
        function setMenuItem(parent, name, menuItem, index, item, plugin){
            ...
            if (!item) {
                ...
                if (itemName != "~")
                    item.setAttribute("caption",
                        apf.escapeXML((debug ? "\\[" + index + "\\] " : "") + itemName));
            }
...
//                });
            ...
            if (!preview) {
                settings.model.setQueryValue("state/menus/@minimized", "false");
                minimized = false;
        ...
        function minimize(preview, noAnim){
            ...
            if (!preview) {
                settings.model.setQueryValue("state/menus/@minimized", "true");
                minimized = true;
        ...
        function Menu(options, forPlugin){
            ...
            /**
             * Menu Class for Cloud9 IDE. Menus can be used anywhere throughout
        ...
        function MenuItem(options, forPlugin){
            ...
            /**
             * MenuItem Class for Cloud9 IDE. Menu items should always be 
            ...
            plugin.freezePublicAPI({
                 ...
                 *         type    : "check"
                 *         caption : "Status Bar"
                 *         checked : "[{settings.model}::user/statusbar/@show]"
                 *     });
                 * 
            ...
            plugin.load("menuitem" + item_counter++);
        ...
        function Divider(options, forPlugin){
            ...
            plugin.load("divider" + item_counter++);
