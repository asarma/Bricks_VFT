        ...
        function Form(options){
            ...
            function createItem(heading, name, options, foreign){
                ...
                switch(options.type) {
                    case "checkbox":
                        childNodes = [
                            new ui.label({ width : width, caption: name + ":" }),
                            new ui.checkbox({
                                value  : options.path 
                                    ? "[" + options.path + "]" 
                    ...
                    case "dropdown":
                        ...
                        childNodes = [
                            ...
                            new ui.dropdown({
                                ...
                                margin     : "-1 0 0 0",
                                value      : options.path 
                                    ? "[{settings.model}::" + options.path + "]" //{settings.model}::
                                    : (options.defaultValue || ""),
            ...
            /**
             * Form Builder for Cloud9 IDE. Use this class to create forms
